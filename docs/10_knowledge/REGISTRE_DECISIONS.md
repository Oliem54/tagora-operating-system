...
**Enrichi — fondation TAGORA Sourcing AI** — DEC-024 **Validé** (VALD-103 / ADR-0012, 2026-08-16). Module super-agent défini ; repo non créé ; surfaces candidates. DEC-023 **Validé** (pilote identité Stock ; implémentation non autorisée). DEC-022 **Validé** (contrat handoff). DEC-021 **Validé** (bootstrap identité). DEC-020 **Validé** (mapping). DEC-019 **Validé** (surfaces). DEC-018 **Validé** (charte). DEC-017 **Remplacé**. DEC-016 **Validé**. DEC-015 **Validé**. DEC-014 reste inchangée.

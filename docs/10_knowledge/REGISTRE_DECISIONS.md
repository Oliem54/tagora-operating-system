...
**Enrichi — Mapping intégration modules** — DEC-020 **Validé** (VALD-099 / ADR-0008, 2026-08-16). DEC-019 **Validé** (surfaces). DEC-018 **Validé** (charte). DEC-017 **Remplacé**. DEC-016 **Validé**. DEC-015 **Validé**. DEC-014 reste inchangée.

...
**Enrichi — Charte de marque centrale finale** — DEC-018 **Validé** (VALD-097 / ADR-0006, 2026-08-15). DEC-017 **Remplacé** (`REPLACED_BY_FINAL_BRAND_GUIDE` ; Outfit + Syne LEGACY ; `WAITING_FOR_WEBSITE_EVIDENCE` historiquement CLOSED). DEC-016 **Validé** (VALD-095, 2026-08-13). DEC-015 **Validé** (ADR-0004, 2026-08-12). DEC-014 reste inchangée.

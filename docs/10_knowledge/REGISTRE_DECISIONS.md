...
**Enrichi — sélection pilote identité** — DEC-023 **Validé** (VALD-102 / ADR-0011, 2026-08-16). Stock Premium sélectionné ; implémentation non autorisée. DEC-022 **Validé** (contrat handoff). DEC-021 **Validé** (bootstrap identité). DEC-020 **Validé** (mapping). DEC-019 **Validé** (surfaces). DEC-018 **Validé** (charte). DEC-017 **Remplacé**. DEC-016 **Validé**. DEC-015 **Validé**. DEC-014 reste inchangée.

...
**Enrichi — Contrat d'emplacement des surfaces** — DEC-019 **Validé** (VALD-098 / ADR-0007, 2026-08-16). DEC-018 **Validé** (charte). DEC-017 **Remplacé**. DEC-016 **Validé** (rôle Time public clos par DEC-019 ; redirect non autorisé). DEC-015 **Validé** (ADR-0004, complété). DEC-014 reste inchangée.

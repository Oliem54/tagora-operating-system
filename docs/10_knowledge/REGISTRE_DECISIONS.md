...
**Enrichi — Propriété entrée publique vs Time** — DEC-016 **Validé** (VALD-095, 2026-08-13). DEC-015 **Validé** (ADR-0004, Martin ST-Gelais — Direction, 2026-08-12). DEC-014 reste inchangée.

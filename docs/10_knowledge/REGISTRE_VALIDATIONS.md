...
14. VALD-100 fige uniquement le **bootstrap d'identité et le rattachement conceptuel Time**. Elle n'autorise ni DB, ni copie de mot de passe/hash, ni Entra, ni SSO, ni utilisateur réel. Phase 4D Lot 2 reste inchangée. Prochain transfert recommandé : Mail IA READ-ONLY.

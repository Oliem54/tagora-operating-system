...
| VALD-096 | 2026-08-14 | Fermeture contrat typographique transversal Outfit + Syne | Humaine / Gouvernance | Martin ST-Gelais — Direction | Validé | [VALIDATION_VALD_096_CONTRAT_TYPOGRAPHIQUE_TRANSVERSAL.md](VALIDATION_VALD_096_CONTRAT_TYPOGRAPHIQUE_TRANSVERSAL.md), [ADR-0005](../05_adr/ADR-0005-CONTRAT-TYPOGRAPHIQUE-TRANSVERSAL-OUTFIT-SYNE.md), [CONTRAT_TYPOGRAPHIQUE_TRANSVERSAL.md](../09_design_system/CONTRAT_TYPOGRAPHIQUE_TRANSVERSAL.md), [PAQUET_TRANSFERT_TYPOGRAPHIE_TRANSVERSALE.md](../04_adoption_modules/paquets_transfert/PAQUET_TRANSFERT_TYPOGRAPHIE_TRANSVERSALE.md) | Preuve Website `6415cdd` ; `WAITING_FOR_WEBSITE_EVIDENCE` fermé ; paquets prêts pour transfert Martin ; aucun produit modifié ; contrat couleurs non touché |
...
10. VALD-096 ferme uniquement le **contrat typographique** transversal (Outfit + Syne) à partir de la preuve Website `6415cdd`. Elle n'autorise aucune application produit, ni modification du contrat couleurs, ni DNS/Production.

...
- Site public client X-Plod : `EXTERNAL_CUSTOMER_INTEGRATION_SURFACE` ; **≠** `tagora.ca`. Hors paquet Website. Preflight Pulse : [PAQUET_TRANSFERT_PULSE_P2_XPLOD_WIDGET_PREFLIGHT.md](PAQUET_TRANSFERT_PULSE_P2_XPLOD_WIDGET_PREFLIGHT.md)

...
- Handoff (DEC-022) : [PAQUET_TRANSFERT_HANDOFF_PULSE_AI.md](PAQUET_TRANSFERT_HANDOFF_PULSE_AI.md)
- Widget public X-Plod : hors identité centrale ; preflight distinct : [PAQUET_TRANSFERT_PULSE_P2_XPLOD_WIDGET_PREFLIGHT.md](PAQUET_TRANSFERT_PULSE_P2_XPLOD_WIDGET_PREFLIGHT.md)
